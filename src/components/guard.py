...
class Guard:
    ...
    def __init__(
        ...
        prometheus_service_port = os.environ.get("PROMETHEUS_SERVICE_PORT", "51318")
    ...
    def guard(self) -> None:
        ...
        while self.running:
            ...
            toPrint += " measured: " + str(measured_workload) + " comp: " + str(completed) + " supp: " + str(current_mcl) + " inst: " + str(np.sum(config))
            config = self.scaler.get_current_config()
            print(toPrint)
